var Cut3MarteScene = cc.Scene.extend({
	onEnter : function() {
		this._super();
		var size = cc.Director.getInstance().getWinSize();

		var nomeDoPlaneta = cc.LabelTTF.create("MARTE", "Impact", 48);
		...
		var clickToPlay = cc.LabelTTF.create("Fabiano L. Santos - Level Design\nFabiano L. Santos - Landscape Art", "Arial", 24);
		clickToPlay.setPosition(size.width / 2, size.height / 2);
		this.addChild(clickToPlay, 1);

		var imagemDoPlaneta = cc.Sprite.create(s_marte_cut_image);
